...
settings.topology = os.path.join(settings.topology,"HOIP_apo697_1_af_sample_127_10000_protonated_max_plddt_1969")
...
try:
    ...
    restrants = os.path.join(settings.topology,"HOIP_apo697_1_af_sample_127_10000_protonated_max_plddt_1969_solv_ions.gro")
