...
settings.topology = os.path.join(settings.topology,"BRD4_APO_484_1_af_sample_127_10000_protonated_max_plddt_2399")
...
# specify ARGS: -P, -R, -N
    ...
    restraints = os.path.join(settings.topology, "BRD4_APO_484_1_af_sample_127_10000_protonated_max_plddt_2399_solv_ions.gro")
    # md.check_args()
    md.create_directory_structure(overwrite=True)
    md.run_experiment(search="BRD4", config_files=['2_equil.mdp', '3_equil.mdp', '4_equil.mdp', '5_equil.mdp', '6_equil.mdp', '7_relax.mdp', '8_prod.mdp'], restraints=restraints)
